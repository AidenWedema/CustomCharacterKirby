...
public class IceBlock() : AbilityCard(1, CardType.Skill, CardRarity.Basic, TargetType.Self)
{
    protected override IEnumerable<DynamicVar> OverrideCanonicalVars => [ new BlockVar(9M, ValueProp.Move)];
