...
public abstract class CustomCharacterKirbyCard(int cost, CardType type, CardRarity rarity, TargetType target) :
    CustomCardModel(cost, type, rarity, target)
{
    ...
    public override string BetaPortraitPath => $"beta/card.png".CardImagePath();
}